...
import RetouchingFaqAccording from "./RetouchingFaqAccording";
...
const RetouchingFaq = () => {
  ...
  return (
    <div>
      <div className="md:px-32 px-12 md:py-16  bg-[url('https://cdn-eahnp.nitrocdn.com/LCPkSmIYbLjSQwpkUQQjpTZTKTmMsByp/assets/images/optimized/rev-195c362/clippingpathgraphics.com/wp-content/themes/graphic-it/assets/img/faq-dot.svg')] bg-no-repeat bg-start  bg-contain">
        <div className="">
