      ...
      <div>
        <div className="md:text-center text-start">
          ...
          <div className="md:text-sm text-xs text-center  text-gray-600 font-sans mb-3">
            Clipping Path Graphics ensures professional and top-notch Image
            Shadow Making Service catering to our clients needs. We take pride
            in our professionalism and utmost dedication.
          </div>
        </div>
