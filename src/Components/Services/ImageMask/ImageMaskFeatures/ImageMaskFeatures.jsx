...
import feature_pic from "./../../../Images/ServiceImage/Mask/mask_features.png";
const ImageMaskFeatures = () => {
  return (
    <div>
      <div
        ...
        <div className="md:grid   md:grid-cols-3 md:gap-2  ">
          <div className="">
            ...
            <div className="text-start md:text-sm text-xs md:mt-8 mt-4 ">
              ...
              professional masking service maintaining quality. Our adjustments
              include:
            </div>
...
export default ImageMaskFeatures;
