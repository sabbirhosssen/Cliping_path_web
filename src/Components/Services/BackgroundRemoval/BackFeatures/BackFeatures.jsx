import background_feature from "./../../../Images/ServiceImage/Background/background-features.png";
        ...
        <div className="md:grid   md:grid-cols-3 md:gap-2  ">
          <div className="">
            ...
            <div className="text-start md:text-sm text-xs md:mt-8 mt-4 ">
              Our skilled list_iconers will do what it takes to offer you the
              best quality. Our adjustments include:
            </div>
