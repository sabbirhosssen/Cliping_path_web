...
const BackFeatures = () => {
  const feature_shadaw =
    "https://cdn-eahnp.nitrocdn.com/LCPkSmIYbLjSQwpkUQQjpTZTKTmMsByp/assets/images/optimized/rev-195c362/clippingpathgraphics.com/wp-content/themes/graphic-it/assets/img/background-remove-image.jpg";
  const design =
        ...
        <div className="md:grid   md:grid-cols-3 md:gap-2  ">
          <div className="">
            ...
            <div className="text-start md:text-sm text-xs md:mt-8 mt-4 ">
              Our skilled designers will do what it takes to offer you the best
              quality. Our adjustments include:
            </div>
