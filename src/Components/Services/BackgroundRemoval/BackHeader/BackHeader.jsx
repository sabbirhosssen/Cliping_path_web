...
import backheader from "./../../../Images/ServiceImage/Background/Background-Remove-service-h2.png";
import backheader_bg from "./../../../Images/ServiceImage/Global/Global_Head_bg.png";
const BackHeader = () => {
  return (
    <div>
      <div
        className="bg-[#f5f6fb]  md:px-32 px-12 pb-16 py-6 bg-no-repeat bg-center  "
        style={{ backgroundImage: `url(${backheader_bg})` }}
      >
        <div className="md:flex  md:justify-center md:items-center md:gap-5">
          ...
          <div className="md:w-6/12 relative">
            <img src={backheader} className=" md:ms-10" alt="" />
